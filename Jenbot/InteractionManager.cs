...
public static class InteractionManager
{
    ...
    public static void AddHandler(Handler handler) => _handlers.Add(handler);
    ...
    private static IEnumerable<ICommand> LoadCommands() => from t in Assembly.GetExecutingAssembly().GetTypes()
